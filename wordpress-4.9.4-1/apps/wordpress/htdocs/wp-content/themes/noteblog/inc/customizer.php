...
function noteblog_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section(
		'noteblog_help_and_support_today',
		array(
	...
	$wp_customize->add_setting('noteblog_help_and_support_today_extratab', array(
		'sanitize_callback' => 'unneeded',
		'type' => 'info_control',
		'capability' => 'edit_theme_options',
		)
	);
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'help_and_support_today', array(
		'section' => 'noteblog_help_and_support_today',
		'settings' => 'noteblog_help_and_support_today_extratab',
		'type' => 'none',
		'priority' => 105
		) )
	);   
	...
	$wp_customize->add_setting('noteblog_rating_extratab', array(
		'sanitize_callback' => 'unneeded',
		'type' => 'info_control',
		'capability' => 'edit_theme_options',
		)
	);
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'rating_tabs', array(
		'section' => 'noteblog_rating',
		'settings' => 'noteblog_rating_extratab',
		'type' => 'none',
		'priority' => 105
		) )
	);   
	...
	$wp_customize->add_setting('noteblog_features_tabs', array(
		'sanitize_callback' => 'unneeded',
		'type' => 'info_control',
		'capability' => 'edit_theme_options',
		)
	);
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'features_tabs', array(
		'section' => 'noteblog_features_all',
		'settings' => 'noteblog_features_tabs',
		'type' => 'none',
		'priority' => 109
		) )
	);   
...
if(! function_exists('noteblog_backendfunctions' ) ):
	
function noteblog_backendfunctions(){
	...
	<?php }
	add_action( 'wp_head', 'noteblog_backendfunctions' );
	endif;
